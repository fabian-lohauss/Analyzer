...
public sealed class WdsfProfileParserTests
{
    ...
    public void Parse_normalizes_profile_and_filters_competitions()
    {
        const string html = """
            ...
            <table><tr><td><a href="/Couples/Clemens-Kalmer-and-Petra-Kalmer-123">info</a></td><td>Petra Kalmer</td><td>Germany</td><td>Germany</td><td>Active</td><td>19/10/2002</td><td></td></tr></table>
            <table>
        ...
        Assert.Equal("https://www.worlddancesport.org/Couples/Clemens-Kalmer-and-Petra-Kalmer-123", result.Partnership?.CoupleUrl.AbsoluteUri);
    ...
    [Fact]
    public void Couple_parser_builds_ordered_min_key()
    {
        const string html = """
            <dl>
              <dt>Man</dt><dd><a href="/Athletes/Fabian">Fabian Lohauss</a> (10006615)</dd>
              <dt>Woman</dt><dd><a href="/Athletes/Simone">Simone Braunschweig</a> (10023815)</dd>
            </dl>
            """;
        var partnership = new Partnership(
            "Simone Braunschweig", "Germany", null, "Active",
            new Uri("https://www.worlddancesport.org/Couples/Fabian-and-Simone-1"));

        var result = new WdsfCoupleParser().Parse(html, partnership);

        Assert.Equal("10006615", result.ManMin);
        Assert.Equal("10023815", result.LadyMin);
        Assert.Equal("10006615-10023815", result.CacheKey);
    }
